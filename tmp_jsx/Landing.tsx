...
<div className="group fade-in-section" style={{"transitionDelay": "200ms"}}>
<div className="mb-8 opacity-50 group-hover:opacity-100 transition-opacity">
...
<div className="group fade-in-section" style={{"transitionDelay": "400ms"}}>
<div className="mb-8 opacity-50 group-hover:opacity-100 transition-opacity">
...
<div className="w-full lg:w-1/2 space-y-12 fade-in-section" style={{"transitionDelay": "300ms"}}>
...
<div className="p-10 rounded-3xl bg-slate-900 dark:bg-brand-green/10 border border-primary flex flex-col relative scale-105 shadow-2xl z-10 fade-in-section" style={{"transitionDelay": "200ms"}}>
...
<div className="p-10 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 flex flex-col fade-in-section" style={{"transitionDelay": "400ms"}}>
